...
@implementation TwittermaniaAppDelegate (MOC)
...
- (NSManagedObjectModel *)createManagedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Twittermania" withExtension:@"momd"];
